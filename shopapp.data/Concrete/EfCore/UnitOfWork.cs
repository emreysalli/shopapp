...
namespace shopapp.data.Concrete.EfCore
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private EfCoreProductRepoistory _productRepository;
        public ICartRepository Carts => _cartRepository = _cartRepository ?? new EfCoreCartRepository(_context);
        public IProductRepository Products => _productRepository = _productRepository ?? new EfCoreProductRepoistory(_context);
