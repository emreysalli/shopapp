...
namespace shopapp.webui.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private void SaveOrder(OrderModel model, Payment payment, string userId)
        {
            ...
            order.PaymentType = EnumPaymentTypes.CrediCard;
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-kE7Fyrd0Pp5hmGKcvx9jAA1mbaWw1DZT";
            options.SecretKey = "sandbox-96yqLkczgAafGNCNrk0OJVzm1K2sL4iZ";
            ...
            // paymentCard.CardNumber = "552879000000008";
